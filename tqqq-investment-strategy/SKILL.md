...
执行输出严格只使用以下五大板块；取消所有图表和表格。每个板块只写一行“结论”，不追加其他字段、解释或链接。

### 核心结论

截止日期：YYYY-MM-DD HH:mm（时区；收盘/盘中）

结论：[行动状态]。概括位置、估值、压力和三因子关系。

### 均线位置

结论：说明 QQQ/TQQQ 相对均线的位置、偏离和买入条件是否满足。

### 估值水平

结论：说明 Nasdaq-100 forward P/E、历史位置、实际盈利和盈利预期对行动的影响。

### 金融压力

结论：说明信用、流动性、波动的水平、方向、速度及其对行动的影响。
